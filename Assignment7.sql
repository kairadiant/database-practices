...
/* [5c/d] Create a stored procedure random_points(n) that generates n random points (x, y) where both x and y are in the interval (-1, 1) */
...
/* [8] run test for 100 points */
CALL run_test(100);
/* [8] run test for 1000 points */
CALL run_test(1000);
/* [8] run test for 10'000 points */
CALL run_test(10000);

/* [9] find estimate of pi for different n */
SELECT * FROM math_circle;